...
$id_ubi_perso=array_keys($ciu_opc, "el dojo guardián");
$id_perso=datos::personaje($_SESSION['id_usuario'], $_SESSION['num_perso'], "id_personaje_usu");
gamemysql::query("UPDATE usu_personajes SET ubi_ciu_perso='".$id_ubi_perso[0]."' WHERE id_personaje_usu='".$id_perso."'")or die(mysql_error());
...
echo '<h1>El Dojo Guardian</h1><hr>';
